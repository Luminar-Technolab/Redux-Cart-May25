...
const Footer = () => {
  return (
     <div style={{height:'250px',marginTop:'100px'}} className=' mt-5 w-full bg-violet-900 text-white p-4'>
      ...
      <p className='text-center mt-3 text-white'>Copyright &copy; May 2025 Batch, Daily Cart. Built with React Redux.</p>
    </div>
  )
}
